export const weeklyBuffet = {
    ...
    Saturday: {
        lunch: [
            { itemName: "Chicken Korma ", price: "139 kr", itemDescription: "A popular Indian festive stew with garlic, ginger, garam masala, yogurt, condensed butter, raisins, cashew nuts and almond mixture korma sauce." },
            { itemName: "Lamb Rogan Josh", price: "139 kr", itemDescription: "Lamb Rogan Josh is a classic Kashmiri, slow-cooked lamb curry known for its deep red color, tender meat, and rich, aromatic gravy." },
...
export const otherItems= {
    bread : ["Nan bread", "Garlic Nan","Butter Nan","Parata","Tandori Roti"],
    soup : ["Lentil Soup", "Chicken Soup","Tomato Soup"],
    starter : ["Pakoda", "Manchurian", "Samosa"],
    desert : ["Mango Kulfi","Gulab Jamun","Vanilla Icecream","Chocolate Icecream"]
}